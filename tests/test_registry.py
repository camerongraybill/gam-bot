...
from gam_bot.command import Command, REGISTRY, DiscordCommandRegistry
...
class CommandTest(TestCase):
    ...
    def test_registry_dispatch_args(self):
        registry = DiscordCommandRegistry()
        command: Command = REGISTRY.from_args("test", None, ("Response", ), lambda a, b: b)
        registry.register(command)
        self.assertSequenceEqual(registry.dispatch("test arg1 arg2", "channel"), ("arg1", "arg2"))
